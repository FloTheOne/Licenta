...
class Ui_Form(object):
    ...
    """)
        ...
        self.label = QtWidgets.QLabel("Folder/Partition Name")
        ...
        self.addPartitionButton = QtWidgets.QPushButton("Add Partition")
        self.removePartitionButton = QtWidgets.QPushButton("Remove Partition")
