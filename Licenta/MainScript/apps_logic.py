...
class AppsLogic(QWidget):
    def __init__(self, project_context):
        ...
        self.ui.addFile.clicked.connect(self.add_folder)
    ...
    def go_back_to_folder_selection(self):
        from MainScript.folder_logic import FolderLogic  # evită importul circular
        self.context.set_apps_structure(self.folder_structure)
        self.context.set_apps_global(self.app_paths)
    ...
    def add_folder(self):
        QMessageBox.information(self, "Info", "This action is disabled. Folder tree is read-only here.")
